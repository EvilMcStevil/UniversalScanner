...
{
    class Hanwha : ScanEngine, IScanner
    {
        ...
        public ILogger<Hanwha> Logger { get; }
        public Hanwha(ILogger<Hanwha> logger, IConfig config) : base(logger, config)
        {
            this.Logger = logger;
        ...
        public override void reciever(IPEndPoint from, byte[] data)
        {
            ...
            {
                ip = from.Address;
                Logger.LogWarning( String.Format("Warning: Hawha.reciever(): Invalid ipv4 format: {0}", deviceIP));
            }
