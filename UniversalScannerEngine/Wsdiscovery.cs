...
{
    class Wsdiscovery : ScanEngine, IScanner
    {
        ...
        public ILogger<Wsdiscovery> Logger { get; }
        public Wsdiscovery(ILogger<Wsdiscovery> logger, IConfig config) : base(logger, config)
        {
            if (Config.onvifVerbatim)
            {
                announce = verbatim;
                Logger.LogWarning( "Using WSDiscovery ONVIF verbatim payload");
            }
        ...
        public override void reciever(IPEndPoint from, byte[] data)
        {
            ...
            {
                Logger.LogWarning( "Wsdiscovery.reciever(): Error: Unable to read text");
            }
